...
> [!IMPORTANT] > **Abyssal** 需要运行在 **macOS 13.0 Ventura**[^check_your_macos_version] 及以上的系统中。
...
[^cursor_onto_status_bar]: 你需要将光标移至比`菜单分隔符`离屏幕角落更远的位置以触发动作。在一些带有刘海的屏幕上，你可能还需要将光标置于*刘海右侧和`菜单分隔符`之间。*
