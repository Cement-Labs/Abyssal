...
**Stalker** 将你的菜单栏划分为三个区域 - ![永远隐藏区域](https://img.shields.io/badge/永远隐藏区域-EEAAFF)、![隐藏区域](https://img.shields.io/badge/隐藏区域-FFAAAA) 和 ![显示区域](https://img.shields.io/badge/显示区域-AADEFF)。

- ![永远隐藏区域](https://img.shields.io/badge/永远隐藏区域-EEAAFF) - 此区域内的图标将被<i>永远隐藏，</i>除非你主动查看它们。
- ![隐藏区域](https://img.shields.io/badge/隐藏区域-FFAAAA) - 此区域内的图标遵循一定的显示逻辑。通常情况下，*你看不到它们。*
- ![显示区域](https://img.shields.io/badge/显示区域-AADEFF) - 此区域内的图标*不受影响。*
