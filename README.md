...
[^cursor_onto_status_bar]: You need to move your cursor to the left of `Menu Icon`&thinsp;<picture><source media="(prefers-color-scheme: dark)" srcset="/Docs/Contents/DefaultTheme/Dark/Dot.png?raw=true" /><img height="12" src="/Docs/Contents/DefaultTheme/Light/Dot.png?raw=true" /></picture> in order to trigger something. On monitors with notches, you may also need to move your cursor to the right of the notch.
