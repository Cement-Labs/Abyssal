...
<div align="center">
  <picture>
    <source
      ...
      srcset="Contents/简体中文/Dark/P1.png?raw=true"
     />
    <img
      width="450"
      src="Contents/简体中文/Light/P1.png?raw=true"
     />
  </picture>
</div>
...
默认值为 `Stalker`。不同主题间的显示效果迥异，并且一些主题会自动隐藏分隔图标，另一些则不会。
...
<div align="center">
  <picture>
    <source
      media="(prefers-color-scheme: dark)"
      srcset="Contents/简体中文/Dark/P2.png?raw=true"
     />
    <img
      width="450"
      src="Contents/简体中文/Light/P2.png?raw=true"
     />
  </picture>
</div>
...
- 值为 `关` - 需要手动控制处于 <sub><picture><source media="(prefers-color-scheme: dark)" srcset="https://img.shields.io/badge/隐藏区域-903150" /><img src="https://img.shields.io/badge/隐藏区域-FFC9D9" /></picture></sub> 的菜单栏图标的显示和隐藏状态。
- 值为 `开` - **Stalker** 会在你不需要使用菜单栏时自动隐藏处于 <sub><picture><source media="(prefers-color-scheme: dark)" srcset="https://img.shields.io/badge/隐藏区域-903150" /><img src="https://img.shields.io/badge/隐藏区域-FFC9D9" /></picture></sub> 的菜单栏图标。

###### 反馈强度

从左至右的值分别为 - `关闭`、`轻`、`中` 和 `重`。默认值为 `关闭`。
...
<div align="center">
  <picture>
    <source
      media="(prefers-color-scheme: dark)"
      srcset="Contents/简体中文/Dark/P3.png?raw=true"
     />
    <img
      width="450"
      src="Contents/简体中文/Light/P3.png?raw=true"
     />
  </picture>
</div>
...
<div align="center">
  <picture>
    <source
      media="(prefers-color-scheme: dark)"
      srcset="Contents/简体中文/Dark/P4.png?raw=true"
     />
    <img
      width="450"
      src="Contents/简体中文/Light/P4.png?raw=true"
     />
  </picture>
</div>
...
<div align="center">
  <picture>
    <source
      media="(prefers-color-scheme: dark)"
      srcset="Contents/简体中文/Dark/P5.png?raw=true"
     />
    <img
      width="450"
      src="Contents/简体中文/Light/P5.png?raw=true"
     />
  </picture>
</div>
...
- 值为 `关` - 你需要手动开启 **Stalker**。
- 值为 `开` - **Stalker** 将随 macOS 启动。
